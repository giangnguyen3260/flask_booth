...
class _CouponScreenState
    extends BasePageState<CouponListenState, CouponProvider, CouponScreen> {
  ...
  @override
  bool allowToBack(CouponProvider provider) {
    return false;
  }
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 18.w),
                          _CloseButton(onTap: () => navigator.maybePop()),
                        ],
                      ),
                      ...
                      _VerifyButton(
                        ...
                        onTap: () {
                          if (_textEditingController.text.isNotEmpty) {
                            provider.checkCoupon(_textEditingController.text);
                          }
                        },
                      ),
                      ...
                      Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        style: style24400.copyWith(
                          color: provider.error?.isNotEmpty == true
